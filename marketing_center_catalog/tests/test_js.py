...
class TestMarketingCatalogJS(HttpCase):
    ...
    def _run_qunit(self, mode):
        ...
        self._logger.info("Marketing QUnit verified: marketing_center_catalog %s", mode)
